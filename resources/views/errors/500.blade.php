                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center mb-5">
                            <h1 class="display-2 fw-medium">5<i class="bx bx-buoy bx-spin text-primary display-3"></i><i class="bx bx-buoy bx-spin text-primary display-3"></i></h1>
                            <h4 class="text-uppercase">An Error has occured. We're Fixing it.</h4>
                            <div class="mt-5 text-center">
                                <a class="btn btn-primary waves-effect waves-light" href="{{ route('logout') }}">Go back</a>
                            </div>
                        </div>
                    </div>
                </div>
